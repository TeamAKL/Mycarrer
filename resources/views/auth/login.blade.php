...
{{--                        </div>--}}
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <input type="submit" value="Login" class="btn btn-primary" title="MyCarrer Sign In" style="width: 100%;background-color: #015ea1">
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-center">
                            <a href=""  class="singup_btn text-md-center">New Member ? Sign Up</a>
                        </div>
                    </form>
                </div>
            </div>
